...
public class CustomAlarmTimeValue {
    ...
    public static int[] customValueCorrespondingNames = new int[]{
            ...
            R.string.custom_values_360_label,
            R.string.custom_values_720_label,
            R.string.custom_values_1440_label,
            R.string.custom_values_2880_label
    };
    public static int[] customValueCorrespondingShort = new int[]{
            ...
            R.string.custom_values_360_label_short,
            R.string.custom_values_720_label_short,
            R.string.custom_values_1440_label_short,
            R.string.custom_values_2880_label_short
    };
